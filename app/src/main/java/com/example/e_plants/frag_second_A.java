...
// 測量輪廓
    ...
    private void readData() {
        ...
        databaseReference.child("DHT").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot user : snapshot.getChildren()) {
                    String MA=user.getValue().toString();
                  //System.out.println(MA);
                    StringList.add(MA);
                }
                textTemper.setText( StringList.get(0)+"°c");
                textHumid.setText( StringList.get(1)+"%");
                /*for (DataSnapshot user : snapshot.getChildren()) {
                    String MA = user.child("Temperature").getValue().toString();
                    System.out.println("Temperature is:"+MA);
                }*/
                //textTemper.setText("b");
                /*for (DataSnapshot user : snapshot.getChildren()) {
                    Toast.makeText(frag_second_A.this, "read successfully", Toast.LENGTH_SHORT).show();
                    //DataSnapshot dataSnapshot=task.getResult();
                    System.out.println("~~~~");
                    textTemper.setText(String.valueOf(user.child("Temperature").getValue())+"°c");
                    //textTemper.setText(String.valueOf(user.child("DHT").child("Temperature").getValue())+"°c");
                    //textTemper.setText(String.valueOf(user.child("Temperature").getValue())+"°c");
                    //textTemper.setText("a");
                   //textHumid.setText(String.valueOf(user.child("DHT").child("Humidity").getValue())+ "%");
             } */
            }
            @Override
